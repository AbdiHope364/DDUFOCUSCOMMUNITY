...
import { ShieldAlert, Heart, Phone, Mail, MessageSquare, AlertCircle, ArrowLeft } from 'lucide-react';
...
export default function HelpPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      {/* Disclaimer Notice */}
      <div className="bg-blue-50 border border-blue-200 text-blue-900 rounded-2xl p-4 text-xs flex items-start gap-3">
        <AlertCircle className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
        <div className="space-y-1">
          <div className="font-bold text-slate-900">Confidentiality & Care Notice:</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h3 className="font-bold text-sm text-slate-900">Yonas Solomon</h3>
              <p className="text-xs text-blue-700 font-medium">FOCUS Executive Coordinator</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h3 className="font-bold text-sm text-slate-900">Sara Hailu</h3>
              <p className="text-xs text-blue-700 font-medium">Pastoral Care & SISTA Lead</p>
            </div>
          </div>
          <p className="text-xs text-slate-600">
      ...
      <div className="bg-slate-900 text-white rounded-2xl p-6 shadow-md text-center space-y-3">
