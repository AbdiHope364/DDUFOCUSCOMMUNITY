        ...
        <div className="space-y-3">
          {store.announcements.map((ann) => (
            ...
            >
              ...
              <div className="pt-2 border-t border-slate-200 text-slate-500 text-[11px] flex items-center gap-1.5">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white text-slate-900 rounded-2xl max-w-md w-full p-6 shadow-2xl relative border border-slate-200 space-y-4">
            ...
            <form onSubmit={handlePost} className="space-y-3 text-xs">
              ...
              <div>
                <label className="block font-bold text-slate-700 mb-1">Content / Message *</label>
                <textarea
                  rows={4}
                  required
                  value={content}
