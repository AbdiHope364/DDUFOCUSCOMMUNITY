      ...
      <div className="space-y-4">
        ...
        {myPrayers.length === 0 ? (
          <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center space-y-3">
            ...
            <h4 className="font-bold text-sm text-slate-800">No prayer requests submitted yet</h4>
          ...
          <div className="space-y-3">
            {myPrayers.map((prayer) => (
              <div
                key={prayer.id}
                className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm space-y-2 text-xs"
              >
                ...
                <h4 className="font-bold text-sm text-slate-900">{prayer.title}</h4>
                ...
                <div className="pt-2 flex justify-between items-center text-slate-500">
                  ...
                  <span className="text-emerald-700 font-semibold">Active in Prayer</span>
                </div>
              </div>
            ))}
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-purple-500 focus:outline-none"
                />
              </div>

              <div>
                <label className="block font-bold text-slate-700 mb-1">Prayer Message *</label>
                <textarea
                  rows={4}
                  required
                  value={requestBody}
